        ...
        'default' => [
            ...
            'connection_settings' => [
                ...
                'tls' => [
                    ...
                    'allow_self_signed_certificate' => env('MQTT_TLS_ALLOW_SELF_SIGNED_CERT', true),  // CHANGED
                    'verify_peer' => env('MQTT_TLS_VERIFY_PEER', false),  // CHANGED: Disable for HTTP context
                    'verify_peer_name' => env('MQTT_TLS_VERIFY_PEER_NAME', false),  // CHANGED: Disable for HTTP context
