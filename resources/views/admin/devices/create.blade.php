<x-layout>
    <x-slot:title>Create Device</x-slot:title>

    <div class="p-6 max-w-3xl mx-auto">
        <h1 class="text-2xl font-bold text-white mb-6">Create New Device</h1>
            ...
            <form action="{{ route('admin.devices.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="device_id" id="device_id" value="{{ old('device_id') }}" required
                           ...
                           placeholder="esp32-catcage-01">
                    @error('device_id')
                        <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                    @enderror
                    <p class="mt-1 text-xs text-indigo-300">Unique identifier for this device</p>
                </div>
