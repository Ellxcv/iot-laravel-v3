            ...
            <table class="w-full">
                <thead class="bg-white/5 border-b border-white/10">
                    <tr>
                        ...
                        <th class="px-6 py-4 text-left text-sm font-semibold text-indigo-200">Email</th>
                        <th class="px-6 py-4 text-left text-sm font-semibold text-indigo-200">Role</th>
                        <th class="px-6 py-4 text-left text-sm font-semibold text-indigo-200">Created</th>
